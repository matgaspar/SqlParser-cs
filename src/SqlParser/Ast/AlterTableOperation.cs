namespace SqlParser.Ast
{
    ...
    public abstract class AlterTableOperation : IWriteSql
    {
        ...
        public class AddConstraint(TableConstraint TableConstraint) : AlterTableOperation, IElement
        {
        ...
        public class AddColumn(bool ColumnKeyword, bool IfNotExists, ColumnDef ColumnDef) : AlterTableOperation, IIfNotExists, IElement
        {
            public override void ToSql(SqlTextWriter writer)
            {
                writer.Write("ADD");
        ...
        public class DropConstraint(Ident Name, bool IfExists, bool Cascade) : AlterTableOperation
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class DropColumn(Ident Name, bool IfExists, bool Cascade) : AlterTableOperation
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class RenamePartitions(Sequence<Expression> OldPartitions, Sequence<Expression> NewPartitions) : AlterTableOperation, IElement
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class AddPartitions(bool IfNotExists, Sequence<Partition> NewPartitions) : AlterTableOperation, IIfNotExists, IElement
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class DropPartitions(Sequence<Expression> Partitions, bool IfExists) : AlterTableOperation, IElement
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class RenameColumn(Ident OldColumnName, Ident NewColumnName) : AlterTableOperation
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class RenameTable(ObjectName Name) : AlterTableOperation, IElement
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class ChangeColumn(Ident OldName, Ident NewName, DataType DataType, Sequence<ColumnOption> Options) : AlterTableOperation, IElement
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class RenameConstraint(Ident OldName, Ident NewName) : AlterTableOperation
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        public class AlterColumn(Ident ColumnName, AlterColumnOperation Operation) : AlterTableOperation, IElement
        {
            public override void ToSql(SqlTextWriter writer)
            {
        ...
        /// </summary>
        /// <param name="Name"></param>
        public class SwapWith(ObjectName Name) : AlterTableOperation, IElement
        {
            public override void ToSql(SqlTextWriter writer)
            {
