...
public abstract class MergeClause : IWriteSql, IElement
{
    ...
    public class MatchedUpdate(Sequence<Statement.Assignment> Assignments, Expression? Predicate = null) : MergeClause
    {
    ...
    public class MatchedDelete(Expression? Predicate = null) : MergeClause
    {
        public override void ToSql(SqlTextWriter writer)
        {
            writer.Write("WHEN MATCHED");
    ...
    public class NotMatched(Sequence<Ident> Columns, Values Values, Expression? Predicate = null) : MergeClause
    {
        public override void ToSql(SqlTextWriter writer)
        {
