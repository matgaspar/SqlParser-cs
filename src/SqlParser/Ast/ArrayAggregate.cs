namespace SqlParser.Ast
{
    ...
    public class ArrayAggregate([property:Visit(0)]Expression Expression) : IWriteSql, IElement
    {
        [Visit(1)]
    ...
    public class ArrayExpression(Sequence<Expression> Element, bool Named = false) : IWriteSql, IElement
    {
        public void ToSql(SqlTextWriter writer)
        {
