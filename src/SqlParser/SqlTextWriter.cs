...
namespace SqlParser
{
    public class SqlTextWriter : StringWriter
    {
        ...
        // TODO
        public void WriteSql(params object[] args)
        {
            foreach (var arg in args)
            {
                if (arg is IWriteSql sqlObject)
                {
                    // Para objetos IWriteSql, chama ToSql
                    sqlObject.ToSql(this);
                }
                else
                {
                    // Para outros tipos, converte para string e escreve
                    Write(arg.ToString());
                }
            }
        }
